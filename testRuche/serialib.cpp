...
// Implementation de gettimeofday pour Microsoft Windows
// http://mathieuturcotte.ca/textes/windows-gettimeofday/
#if defined (_WIN32) || defined(_WIN64)
int TimeOut::_gettimeofday(struct timeval* p, void* tz) {
...
{
#if defined (_WIN32) || defined(_WIN64)
    _gettimeofday(&PreviousTime, NULL);
#endif
#ifdef __linux__
...
unsigned long int TimeOut::ElapsedTime_ms()
{
    ...
    int sec, usec;
#if defined (_WIN32) || defined(_WIN64)
    _gettimeofday(&CurrentTime, NULL);
#endif
#ifdef __linux__
